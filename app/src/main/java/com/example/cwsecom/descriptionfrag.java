...
public class descriptionfrag extends Fragment {
    ...
    public descriptionfrag(String id) {
        this.id=id;
    ...
    public  descriptionfrag newInstance(String param1, String param2) {
        descriptionfrag fragment = new descriptionfrag(id);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview= inflater.inflate(R.layout.fragment_descriptionfrag, container, false);
     //   Bundle extras = rootview.getIntent().getExtras();
        destextv=rootview.findViewById(R.id.destextv);
        ...
        JsonArrayRequest jsonArrayRequest=new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
             ...
             {
                 try {
                     str =response.getJSONObject(i).getString("description").toString();
                 } catch (JSONException e) {
                     e.printStackTrace();
                 }
             }
                destextv.setText(str);
            }
